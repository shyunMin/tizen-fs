...
class SetTtsEnginePage extends StatefulWidget {
  const SetTtsEnginePage({
    super.key,
    required this.node,
  ...
  @override
  State<SetTtsEnginePage> createState() => _SetTtsEnginePageState();
}

class _SetTtsEnginePageState extends State<SetTtsEnginePage> {
  ...
  void _loadData() async {
    await context.read<TtsSettingProvider>().loadEngineData();
  }

  @override
  void didUpdateWidget(covariant SetTtsEnginePage oldWidget) {
  ...
  Future<void> _applySelection(int index) async {
    final engineId = context.read<TtsSettingProvider>().getEngineId(index);
    await context.read<TtsSettingProvider>().setCurrentEngine(engineId);
  }
